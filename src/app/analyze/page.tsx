...
export default function AnalyzePage() {
    ...
    const handleAnalyze = async () => {
        ...
        console.log(`🔍 Tek fotoğraf analizi başlatılıyor - ${currentImageIndex + 1}/${selectedImages.length}`);
        console.log('📸 Analiz edilecek fotoğraf boyutu:', currentImage?.length || 'undefined');
        ...
        try {
            ...
            console.log('🌐 Tek fotoğraf API yanıt durumu:', response.status, response.statusText);
            ...
            if (response.ok) {
                ...
                console.error('❌ Tek fotoğraf API hatası:', response.status, errorText);
    ...
    const handleAnalyzeAll = async () => {
        ...
        try {
            ...
            console.log('📋 İlk fotoğraf boyutu:', selectedImages[0]?.length || 'undefined');
            ...
            if (response.ok) {
                const result = await response.json();
                console.log(`✅ ${selectedImages.length} fotoğraf başarıyla analiz edildi:`, result);
            ...
            if (error instanceof Error) {
                if (error.message.includes('Analiz sonucu boş')) {
                    alert('Analiz sonucu boş geldi. Lütfen fotoğrafları tekrar kontrol edin ve yeniden deneyin.');
                ...
                alert('Çoklu analiz sırasında beklenmedik bir hata oluştu. Lütfen tekrar deneyin.');
            }
        } finally {
            setIsAnalyzing(false);
        }
                        ...
                        <div className="space-y-6 animate-slide-up">
                            ...
                            <div className="card p-4 bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3">
                                        <h3 className="text-sm font-bold text-amber-800 mb-1">⚠️ Önemli Uyarı</h3>
                                        <p className="text-sm text-amber-700 leading-relaxed">
                                            <strong>Bu analiz yapay zeka tarafından oluşturulmuştur ve sadece tahmini bilgiler içermektedir.</strong>
                                            Gerçek hayvan değerlendirmesi için mutlaka uzman veteriner hekim ve deneyimli besicilik uzmanlarından görüş alınız.
                                            Kesin alım-satım kararları vermeden önce profesyonel inceleme yaptırmanız önerilir.
                                        </p>
                                        <div className="mt-2 text-xs text-amber-600">
                                            📋 Bu rapor referans amaçlıdır • 🧑‍⚕️ Veteriner kontrolü gereklidir • 💰 Piyasa fiyatları değişkendir
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card p-6 bg-gradient-to-r from-success/10 to-primary-50 border-success/20">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-neutral-600">
                                                %{analysisResult.confidence} güven oranı • {analysisResult.analysisType === 'multiple_same_animal' ? `${analysisResult.totalImages} fotoğraf analizi` : 'Tek fotoğraf analizi'}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        ...
                                        <div className="text-sm text-neutral-500">Tahmini Değer</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body space-y-4">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="font-semibold text-primary-700">{analysisResult?.animalType}</span>
                                        </div>
                                        <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="font-semibold text-lg">{analysisResult?.estimatedWeight} kg</span>
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <span className="text-neutral-600">Sağlık Skoru:</span>
                                            <div className="flex items-center">
                                                <span className="font-semibold mr-2">{analysisResult?.healthScore}/100</span>
                                                <span className={`badge ${analysisResult?.healthScore >= 90 ? 'badge-success' : analysisResult?.healthScore >= 80 ? 'badge-warning' : 'badge-error'}`}>
                                                    {analysisResult?.healthScore >= 90 ? 'Mükemmel' : analysisResult?.healthScore >= 80 ? 'İyi' : 'Orta'}
                                                </span>
                                            </div>
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <span className="text-neutral-600">Güven Oranı:</span>
                                            <span className="font-semibold text-green-600">%{analysisResult?.confidence}</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="card-body space-y-4">
                                        <div className="bg-orange-50 p-3 rounded-lg">
                                            <div className="flex justify-between items-center mb-2">
                                                <span className="text-neutral-600">Karkas Ağırlığı:</span>
                                                <span className="font-bold text-orange-700">{analysisResult?.meatYield?.karkasWeight} kg</span>
                                            </div>
                                            <div className="text-xs text-neutral-500">
                                                Karkas Verimi: %{analysisResult?.meatYield?.yieldRatios?.karkasYield}
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-green-50 p-3 rounded-lg">
                                            <div className="flex justify-between items-center mb-2">
                                                ...
                                                <span className="font-bold text-green-700">{analysisResult?.meatYield?.bonelessMeat} kg</span>
                                            </div>
                                            <div className="text-xs text-neutral-500">
                                                Kemiksiz Verimi: %{analysisResult?.meatYield?.yieldRatios?.bonelessYield}
                                            </div>
                                        </div>

                                        <div className="bg-gray-50 p-3 rounded-lg">
                                            <div className="flex justify-between items-center mb-2">
                                                <span className="text-neutral-600">Kemik Ağırlığı:</span>
                                                <span className="font-bold text-gray-700">{analysisResult?.meatYield?.boneWeight} kg</span>
                                            </div>
                                            <div className="text-xs text-neutral-500">
                                                Toplam Et Verimi: %{analysisResult?.meatYield?.yieldRatios?.totalYield}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="card-body space-y-4">
                                        <div className="bg-blue-50 p-3 rounded-lg">
                                            <div className="flex justify-between items-center mb-2">
                                                ...
                                                <span className="font-bold text-blue-700 text-lg">{analysisResult?.marketValue?.toLocaleString()} ₺</span>
                                            </div>
                                            <div className="text-xs text-neutral-500">
                                                Canlı kg: {analysisResult?.pricing?.liveWeightPrice} ₺/kg
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-purple-50 p-3 rounded-lg">
                                            <div className="flex justify-between items-center mb-2">
                                                ...
                                                <span className="font-bold text-purple-700">{analysisResult?.pricing?.estimatedMeatValue?.toLocaleString()} ₺</span>
                                            </div>
                                            <div className="text-xs text-neutral-500">
                                        ...
                                        <div className="bg-yellow-50 p-3 rounded-lg">
                                            <div className="flex justify-between items-center mb-2">
                                                ...
                                                <span className="font-bold text-yellow-700">{analysisResult?.costPerShare?.toLocaleString()} ₺</span>
                                            </div>
                                            <div className="text-xs text-neutral-500">
                                                Kişi başı maliyet
                                            </div>
                                    ...
                                    <div className="card-body space-y-3">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-semibold">
                                                {analysisResult?.analysisType === 'multiple_same_animal' ? 'Çoklu Fotoğraf' : 'Tek Fotoğraf'}
                                            </span>
                                        </div>
                                        {analysisResult?.totalImages > 1 && (
                                            <div className="flex justify-between">
                                                <span className="text-neutral-600">Fotoğraf Sayısı:</span>
                                                <span className="font-semibold">{analysisResult.totalImages} adet</span>
                                            </div>
                                        )}
                                        <div className="flex justify-between">
                                        ...
                                        {analysisResult?.analysisNote && (
                                            <div className="bg-blue-50 p-3 rounded-lg mt-4">
                                                <p className="text-sm text-blue-800">{analysisResult.analysisNote}</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="card-header">
                                    <h3 className="text-xl font-bold text-neutral-900 flex items-center">
                                        ...
                                        <span className="ml-2 text-sm font-normal text-gray-500">
                                            ({selectedImages.length} {selectedImages.length === 1 ? 'fotoğraf' : 'fotoğraf'})
                                        </span>
                                    </h3>
                                </div>
                                <div className="card-body">
                                        ...
                                        <div>
                                            <div className="mb-4 p-3 bg-blue-50 rounded-lg">
                                                <p className="text-sm text-blue-800 text-center">
                                                    <strong>Çoklu Fotoğraf Analizi:</strong> Aynı hayvana ait {selectedImages.length} farklı açıdan fotoğraf analiz edildi
                                                </p>
                                            </div>
                                            ...
                                            <div className="mt-4 text-center">
                                                <p className="text-sm text-gray-600">
                                                    <strong>Not:</strong> Çoklu fotoğraf analizi daha yüksek doğruluk oranı sağlar.
                                                    Ana analiz 1. fotoğraf üzerinden yapılıp diğer açılarla desteklenmiştir.
                                                </p>
                                            </div>
                                        </div>
                                    )}
                            ...
                            <div className="mt-8 p-6 bg-gray-50 border border-gray-200 rounded-lg">
                                <div className="text-center mb-4">
                                    <h4 className="text-lg font-bold text-gray-800 mb-2">📋 Yasal Uyarılar ve Sorumluluk Reddi</h4>
                                </div>

                                <div className="grid md:grid-cols-2 gap-6 text-sm text-gray-700">
                                    <div>
                                        <h5 className="font-semibold text-gray-800 mb-2">🤖 AI Analizi Hakkında</h5>
                                        <ul className="space-y-1 text-xs">
                                            <li>• Bu platform yapay zeka destekli tahmin sistemi kullanır</li>
                                    ...
                                    <div>
                                        <h5 className="font-semibold text-gray-800 mb-2">💰 Fiyat Bilgileri</h5>
                                        <ul className="space-y-1 text-xs">
                                            <li>• Fiyatlar güncel piyasa verilerine dayalıdır</li>
                                            <li>• Bölgesel farklılıklar olabilir</li>
                                            <li>• Mevsimsel dalgalanmalar göz önünde bulundurulmalı</li>
                                            <li>• Kesin fiyat için uzman görüşü alın</li>
                                        </ul>
                                    </div>

                                    <div>
                                        <h5 className="font-semibold text-gray-800 mb-2">🩺 Sağlık ve Veterinerlik</h5>
                                        <ul className="space-y-1 text-xs">
                                    ...
                                    <div>
                                        <h5 className="font-semibold text-gray-800 mb-2">⚖️ Hukuki Sorumluluk</h5>
                                        <ul className="space-y-1 text-xs">
                                ...
                                <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                                    <p className="text-center text-sm text-yellow-800">
                                        <strong>📞 Önemli:</strong> Bu analiz sonuçlarına dayanarak alım-satım kararı vermeden önce
                                        mutlaka <strong>uzman veteriner hekim</strong> ve <strong>deneyimli besicilik uzmanlarından</strong>
                                        görüş alınız. Kurbanlık hayvan seçiminde profesyonel inceleme şarttır.
                                    </p>
                                </div>
                            </div>
                        </div>
