                    ...
                    <div className="card p-8">
                        ...
                        <div className="prose prose-lg max-w-none">
                            ...
                            <p className="mb-6 text-neutral-700 leading-relaxed">
                                ...
                                (&quot;Hizmet&quot;) kullanımını düzenler. Hizmetimizi kullanarak bu
                            ...
                            <div className="bg-warning-50 border border-warning-200 p-6 rounded-lg mb-6">
                                <p className="text-warning-800 leading-relaxed">
                                    <strong>⚠️ Önemli:</strong> Bu şartları dikkatlice okuyunuz. Hizmetimizi
                                    kullanmaya devam ederek bu şartları kabul ettiğinizi beyan edersiniz.
                                </p>
                            </div>
                            ...
                            <p className="mb-4 text-neutral-700 leading-relaxed">
                                Kurbanlık Analiz, yapay zeka teknolojisi kullanarak aşağıdaki hizmetleri sunar:
                            </p>
                            <div className="grid md:grid-cols-2 gap-6 mb-6">
                                <div className="bg-white border border-neutral-200 p-4 rounded-lg">
                                    <h3 className="font-bold text-neutral-900 mb-2">🤖 AI Analiz Hizmetleri</h3>
                                ...
                                <div className="bg-white border border-neutral-200 p-4 rounded-lg">
                                    <h3 className="font-bold text-neutral-900 mb-2">📊 Ek Özellikler</h3>
                                    <ul className="list-disc list-inside text-neutral-700 space-y-1">
                            ...
                            <div className="bg-red-50 border border-red-200 p-6 rounded-lg mb-6">
                                <h3 className="font-bold text-red-800 mb-3">🚫 Yasak Davranışlar</h3>
                            ...
                            <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-6">
                                <h3 className="font-bold text-green-800 mb-3">✅ Doğru Kullanım</h3>
                            ...
                            <p className="mb-4 text-neutral-700 leading-relaxed">
                                Platformumuza yüklediğiniz fotoğraflar için aşağıdaki kurallar geçerlidir:
                            </p>
                            <div className="overflow-x-auto mb-6">
                                <table className="w-full border-collapse border border-neutral-300">
                                    <thead>
                                        <tr className="bg-neutral-100">
                                            <th className="border border-neutral-300 p-3 text-left">İzin Verilen</th>
                                            <th className="border border-neutral-300 p-3 text-left">Yasak</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td className="border border-neutral-300 p-3">Gerçek hayvan fotoğrafları</td>
                                            <td className="border border-neutral-300 p-3">Sahte/manipüle edilmiş görüntüler</td>
                                        </tr>
                                        <tr>
                                            <td className="border border-neutral-300 p-3">Net ve kaliteli görüntüler</td>
                                            <td className="border border-neutral-300 p-3">Müstehcen içerik</td>
                                        </tr>
                                        <tr>
                                            <td className="border border-neutral-300 p-3">Tek hayvan odaklı</td>
                                            <td className="border border-neutral-300 p-3">Şiddet içeren görüntüler</td>
                                        </tr>
                                        <tr>
                                            <td className="border border-neutral-300 p-3">Güncel çekimler</td>
                                            <td className="border border-neutral-300 p-3">Telif hakkı ihlali</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg mb-6">
                                <h3 className="font-bold text-blue-800 mb-3">📋 Analiz Sonuçları Hakkında</h3>
                                <ul className="list-disc list-inside text-blue-700 space-y-2">
                                    <li>Sonuçlar <strong>tahmini</strong> niteliktedir</li>
                            ...
                            <div className="grid md:grid-cols-2 gap-6 mb-6">
                                <div className="bg-white border border-neutral-200 p-4 rounded-lg">
                                    <h3 className="font-bold text-neutral-900 mb-2">🔐 Hesap Güvenliği</h3>
                                    <ul className="list-disc list-inside text-neutral-700 space-y-1">
                                ...
                                <div className="bg-white border border-neutral-200 p-4 rounded-lg">
                                    <h3 className="font-bold text-neutral-900 mb-2">📝 Hesap Bilgileri</h3>
                                    <ul className="list-disc list-inside text-neutral-700 space-y-1">
                            ...
                            <div className="bg-success-50 border border-success-200 p-6 rounded-lg mb-6">
                                <h3 className="font-bold text-success-800 mb-3">🆓 Ücretsiz Hizmet</h3>
                                <p className="text-success-700">
                                    Kurbanlık Analiz platformu tamamen ücretsizdir. Tüm analiz özellikleri
                                    ve hizmetler hiçbir ücret talep edilmeden sunulmaktadır.
                                </p>
                            </div>
                            ...
                            <ul className="list-disc list-inside text-neutral-700 space-y-2 mb-6">
                                <li>Platform tasarımı ve kodları Mehmet Erdem Akın&apos;a aittir</li>
                            ...
                            <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg mb-6">
                                <p className="text-yellow-800 leading-relaxed">
                                    <strong>🔧 Bakım ve Güncellemeler:</strong> Hizmet kalitesini artırmak için
                                    periyodik bakım ve güncellemeler yapabiliriz. Bu durumda kullanıcılar
                                    önceden bilgilendirilir. Plansız kesintiler için sorumluluk kabul etmeyiz.
                                </p>
                            </div>
                            ...
                            <div className="bg-red-50 border border-red-200 p-6 rounded-lg mb-6">
                                <h3 className="font-bold text-red-800 mb-3">⚠️ Sorumluluk Reddi</h3>
                                <ul className="list-disc list-inside text-red-700 space-y-2">
                            ...
                            <div className="grid md:grid-cols-2 gap-6 mb-6">
                                <div className="bg-white border border-neutral-200 p-4 rounded-lg">
                                    <h3 className="font-bold text-neutral-900 mb-2">Kullanıcı Tarafından</h3>
                                    <ul className="list-disc list-inside text-neutral-700 space-y-1">
                                ...
                                <div className="bg-white border border-neutral-200 p-4 rounded-lg">
                                    <h3 className="font-bold text-neutral-900 mb-2">Şirket Tarafından</h3>
                                    <ul className="list-disc list-inside text-neutral-700 space-y-1">
                            ...
                            <div className="bg-neutral-100 p-6 rounded-lg mb-6">
                                <p className="text-neutral-700 leading-relaxed">
                                    <strong>📍 Yetki ve Hukuk:</strong> Bu sözleşmeden doğacak uyuşmazlıklarda
                                    Türkiye Cumhuriyeti yasaları uygulanır. İstanbul Mahkemeleri ve İcra
                            ...
                            <div className="bg-gradient-to-r from-primary-50 to-accent-50 p-6 rounded-lg mb-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <p className="font-bold text-neutral-900 mb-2">🌐 İletişim</p>
                            ...
                            <p className="mb-6 text-neutral-700 leading-relaxed">
                                Bu kullanım şartları, yasal düzenlemeler ve hizmet değişiklikleri
                                doğrultusunda güncellenebilir. Önemli değişiklikler hakkında 30 gün
                                öncesinden bilgilendirileceksiniz. Değişikliklere itiraz etme hakkınız vardır.
                            </p>
