  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 30%, rgba(34, 197, 94, 0.3), rgba(34, 197, 94, 0.1), transparent 70%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 30%, rgba(132, 204, 22, 0.25), rgba(132, 204, 22, 0.08), transparent 70%)",
